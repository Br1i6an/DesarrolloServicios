...
const Update_ProgramController_1 = __importDefault(require("../../src/controllers/programs/Update_ProgramController"));
class ProgramsRoutes {
    ...
    settings() {
        ...
        this.RouteProgramApi.put('/programs/update', Update_ProgramController_1.default.updateProg);
    }
}
